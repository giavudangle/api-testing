...
const dbURI =
  process.env.DB_C0NNECTION_PRODUCTION || process.env.DB_CONNECTION_LOCAL;
...
app.get("/expo", (req, res) => {
  ...
  res.writeHead(301, {
    ...
    Location: `exp://192.168.1.4:19000/--/ResetPassword?userid=${id}&token=${token}`, // Testing on real device (EXPO powered same as expo running bridge id)
  });
  res.end();
});
...
app.get("/", (req, res) => {
  res.send(
    "<img width='100%' height='100%' src='https://res.cloudinary.com/codingwithvudang/image/upload/v1620178049/151284066_207254161142817_5812038792384707893_n_ztp9r6.png'></img>"
  );
});
...
const options = {
  definition: {
    ...
    info: {
      title: "PookBook API",
      version: "1.0.0",
      description: "PookBook Express API",
    },
    servers: [
      {
